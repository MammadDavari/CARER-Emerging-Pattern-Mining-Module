...
/**
 * This is an implementation of the "FHM" algorithm for High-Utility Itemsets MiningConfiguration
 * as described in the conference paper : <br/><br/>
 * 
 *  Fournier-Viger, P., Wu, C.-W., Zida, S., Tseng, V. (2014) FHM: A Faster High-Utility Itemset 
 *  MiningConfiguration Algorithm using Estimated Utility Co-occurrence Pruning.
